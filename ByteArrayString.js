...
ByteArrayString = function(data, endian) {
	
	if(data == undefined) data = '';
	var buff = [], t = this, i = t.length = data.length;
	t.position = 0;
	t.endian = (endian !== undefined) ? endian : ByteArrayString.BIG_ENDIAN;
	t._bitBuffer = null;
	t._bitPosition = 8;
...
ByteArrayString.BIG_ENDIAN = "bigEndian";
ByteArrayString.LITTLE_ENDIAN = "littleEndian";

ByteArrayString.prototype = {
	...
	readNumber: function(numBytes, bigEnd) {
		var t = this, val = 0;
		if (bigEnd == undefined) bigEnd = !!(this.endian == ByteArrayString.BIG_ENDIAN);
		if (bigEnd) {
...
module.exports = ByteArrayString;
